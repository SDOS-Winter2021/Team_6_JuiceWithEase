    ...
    user_data_body = json.dumps(
        {
            ...
            u"links": {
                u"avatar": {
                    u"href": u"https://bitbucket.org/account/foobar/avatar/32/"
                },
                u"followers": {
                    u"href": u"https://api.bitbucket.org/2.0/users/foobar/followers"
                },
                u"following": {
                    u"href": u"https://api.bitbucket.org/2.0/users/foobar/following"
                },
                u"hooks": {
                    u"href": u"https://api.bitbucket.org/2.0/users/foobar/hooks"
                },
                u"html": {u"href": u"https://bitbucket.org/foobar"},
                u"repositories": {
                    u"href": u"https://api.bitbucket.org/2.0/repositories/foobar"
                },
            ...
            u"values": [
                {
                    ...
                    u"links": {
                        u"self": {
                            u"href": u"https://api.bitbucket.org/2.0/user/emails/foo@bar.com"
                        }
                    },
                    u"type": u"email",
                },
                {
                    ...
                    u"links": {
                        u"self": {
                            u"href": u"https://api.bitbucket.org/2.0/user/emails/not@confirmed.com"
                        }
                    },
                    u"type": u"email",
                },
