...
![alt text](images/user_journey.png "User_Journey")
...
- Change product availability
    - Admin can choose which products are available and which are not and depending on that the availability will be shown in the website for the customers to order.
Low Priority Features
